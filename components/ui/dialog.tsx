  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Popup
        ...
        className={cn(
          "fixed inset-0 z-50 flex h-dvh w-dvw flex-col bg-background text-foreground transition duration-200 ease-in-out data-ending-style:opacity-0 data-starting-style:opacity-0",
          className
        )}
        {...props}
      >
